...
reported to the project maintainer, [@FellypeMelo](https://github.com/FellypeMelo).
GitHub Security Advisories (see [SECURITY.md](SECURITY.md)) are for
vulnerability reports, not conduct issues — for a conduct report, contact the
maintainer directly through their GitHub profile linked above. All complaints
