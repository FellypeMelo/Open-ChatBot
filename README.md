...
O motor cognitivo do chatbot baseia-se em um template dinâmico de 6 camadas (definido no componente [Brain](src/backend/core/orchestration/bridge.py#L79)):
...
### 3. Design Patterns
*   **Facade / Orchestration:** A classe [Brain](src/backend/core/orchestration/bridge.py#L79) abstrai a complexidade do pipeline de geração de respostas, ocultando acessos concorrentes ao Vector Store, banco de dados relacional e mecanismos de parser.
