...
async def test_lorebook_integration():
    ...
    try:
        ...
        with patch("src.backend.core.context.lorebook_scanner.LorebookScanner") as mock_scanner_class:
            ...
            mock_scanner.scan_and_extract.return_value = ["The Sword of Destiny is a legendary blade forged in the fires of Mount Doom."]
            ...
            prompt = await brain.build_prompt(user_msg, char, state, user=user, db=MagicMock())
