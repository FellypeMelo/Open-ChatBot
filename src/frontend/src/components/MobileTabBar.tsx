 ...
 */
const MobileTabBar: React.FC<MobileTabBarProps> = ({ currentView, setView }) => (
  <nav
    aria-label="Primary"
    className="fixed bottom-0 inset-x-0 z-40 flex items-stretch bg-[#0A0A0B]/95 backdrop-blur-md border-t border-white/10 pb-[env(safe-area-inset-bottom)]"
  >
    {TABS.map((tab) => {
